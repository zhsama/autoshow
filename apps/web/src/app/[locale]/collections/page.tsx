        ...
        {collections.map((collection) => (
          <Card key={collection.id} className="hover:shadow-lg transition-shadow cursor-pointer">
            <CardHeader className="p-4 md:p-6">
              ...
              <CardTitle className="mt-4 text-base md:text-lg">{collection.name}</CardTitle>
              <CardDescription className="text-xs md:text-sm">{collection.description}</CardDescription>
            </CardHeader>
